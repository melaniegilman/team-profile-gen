...
inquirer
    .prompt({
        ...
        },
        {
            type: 'text',
            name: 'email_address',
            text: 'What is team managers email address?',
        },
        {
            type: 'text',
            name: 'office_number',
        ...
        // -- ask what sort of employee
        // -- get that info
        // -- then
        // -- -- if manager - new manger
        // -- -- els if ena
        // -- -- stop
...
// WHEN I enter the team manager’s name, ID, email address, and office number
